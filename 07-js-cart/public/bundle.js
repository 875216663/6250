...
var state = {
  ...
  getCartCount: function getCartCount() {
    return this.products.reduce(function (total, _ref) {
      var count = _ref.count;
      return total + count;
    }, 0);
  },
  getPricePerProduct: function getPricePerProduct(index) {
    var _this$products$index = this.products[index],
      count = _this$products$index.count,
      price = _this$products$index.price;
    return (count * price).toFixed(2);
  },
  getTotalPrice: function getTotalPrice() {
    return this.products.reduce(function (total, _ref2) {
